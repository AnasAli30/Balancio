    ...
    readonly metadata: {
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly chain: {
                    readonly type: "string";
                    readonly enum: readonly ["amoy", "arbitrum", "arbitrum_nova", "arbitrum_sepolia", "avalanche", "avalanche_fuji", "b3", "b3_sepolia", "baobab", "base", "base_sepolia", "blast", "blast_sepolia", "ethereum", "klaytn", "matic", "mumbai", "optimism", "optimism_sepolia", "sei_testnet", "sepolia", "solana", "soldev", "zora", "zora_sepolia"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly include_private_listings: {
                    readonly type: "boolean";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "If true, will include private listings. Default: false";
                };
            };
            readonly required: readonly [];
        }];
